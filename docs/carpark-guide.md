...
| ---------- |--------------------------------------------------------------------|--------------------------------------------|
| `CarPark`    | - parking lot location<br/>- total spaces<br/> - total available spaces | - car entering spot<br/>- car exiting spot |
...
![Added config methods to the car park class](screenshots/config-methods-to-carpark.png)
...
1. Add a screenshot of the output of the `main.py` file:
   ...
   ![Main.py output](screenshots/main-py-output.png)
